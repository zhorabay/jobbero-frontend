...
export const fetchLessons = (categoryId, courseId, courseModuleId) => (dispatch) => {
  ...
  axios.get(`https://api.origin8lab.com/api/v1/categories/${categoryId}/courses/${courseId}/course_modules/${courseModuleId}/lessons`)
    .then((response) => {
...
export const postLesson = (categoryId, courseId, courseModuleId, formData) => (dispatch) => {
  ...
  axios.post(`https://api.origin8lab.com/api/v1/categories/${categoryId}/courses/${courseId}/course_modules/${courseModuleId}/lessons`, formDataObj, {
    headers: {
