...
export const fetchCourseModules = (categoryId, courseId) => (dispatch) => {
  ...
  axios.get(`https://jobbero-backend.onrender.com/api/v1/categories/${categoryId}/courses/${courseId}/course_modules`)
    .then((response) => {
...
export const postCourseModule = (categoryId, courseId, courseModuleData) => (dispatch) => {
  ...
  axios.post(`https://jobbero-backend.onrender.com/api/v1/categories/${categoryId}/courses/${courseId}/course_modules`, courseModuleData)
    .then((response) => {
