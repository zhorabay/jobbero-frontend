...
export const fetchCourses = (categoryId) => (dispatch) => {
  ...
  axios.get(`https://api.origin8lab.com/api/v1/categories/${categoryId}/courses`)
    .then((response) => {
...
export const postCourse = (categoryId, courseData) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(`https://api.origin8lab.com/api/v1/categories/${categoryId}/courses`, courseData);
