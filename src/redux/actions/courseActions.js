...
export const fetchCourses = (categoryId) => (dispatch) => {
  ...
  axios.get(`https://origin8lab-9812617f1fe1.herokuapp.com/api/v1/categories/${categoryId}/courses`)
    .then((response) => {
...
export const postCourse = (categoryId, courseData) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(`https://origin8lab-9812617f1fe1.herokuapp.com/api/v1/categories/${categoryId}/courses`, courseData);
