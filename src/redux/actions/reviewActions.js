...
export const fetchReviews = (categoryId, courseId) => (dispatch) => {
  ...
  axios.get(`https://origin8lab-cu7g.onrender.com/api/v1/categories/${categoryId}/courses/${courseId}/reviews`)
    .then((response) => {
...
export const postReview = (reviewData, categoryId, courseId) => (dispatch) => {
  ...
  axios.post(`https://origin8lab-cu7g.onrender.com/api/v1/categories/${categoryId}/courses/${courseId}/reviews`, reviewData)
    .then((response) => {
