...
export const fetchReviews = (categoryId, courseId) => (dispatch) => {
  ...
  axios.get(`https://jobbero-backend-gcp91qfk2-zhorabays-projects.vercel.app/api/v1/categories/${categoryId}/courses/${courseId}/reviews`)
    .then((response) => {
...
export const postReview = (reviewData, categoryId, courseId) => (dispatch) => {
  ...
  axios.post(`https://jobbero-backend-gcp91qfk2-zhorabays-projects.vercel.app/api/v1/categories/${categoryId}/courses/${courseId}/reviews`, reviewData)
    .then((response) => {
