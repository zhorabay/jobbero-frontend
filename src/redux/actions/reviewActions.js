...
export const fetchReviews = (categoryId, courseId) => (dispatch) => {
  ...
  axios.get(`https://api.origin8lab.com/api/v1/categories/${categoryId}/courses/${courseId}/reviews`)
    .then((response) => {
...
export const postReview = (reviewData, categoryId, courseId) => (dispatch) => {
  ...
  axios.post(`https://api.origin8lab.com/api/v1/categories/${categoryId}/courses/${courseId}/reviews`, reviewData)
    .then((response) => {
