...
export const fetchCategories = () => (dispatch) => {
  ...
  axios.get('https://origin8lab-9812617f1fe1.herokuapp.com/api/v1/categories')
    .then((response) => {
...
export const postCategory = (categoryData) => (dispatch) => {
  ...
  axios.post('https://origin8lab-9812617f1fe1.herokuapp.com/api/v1/categories', categoryData)
    .then((response) => {
