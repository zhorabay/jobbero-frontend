...
export const fetchCategories = () => (dispatch) => {
  ...
  axios.get('https://jobbero-backend-gcp91qfk2-zhorabays-projects.vercel.app/api/v1/categories')
    .then((response) => {
...
export const postCategory = (categoryData) => (dispatch) => {
  ...
  axios.post('https://jobbero-backend-gcp91qfk2-zhorabays-projects.vercel.app/api/v1/categories', categoryData)
    .then((response) => {
